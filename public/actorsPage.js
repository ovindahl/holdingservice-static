const ActorsPage = {
    ...
    Actions: State => returnObject({
        ...
        "ActorsPage/createActor": async actor => updateState( State, {DB: await Transactor.createEntity(State.DB, 7979, [ newDatom( 'newEntity' , 'entity/company', State.S.selectedCompany )] )} ),
    })
  }
  ...
  let singleActorView = State => {
    ...
    return d([
      ...
      isDefined( State.DB.get( actor, "actor/actorType") )
          ...
          : d(""),
      submitButton("Slett", e => State.Actions["ActorsPage/retractActor"]( actor ) ),  
    ])
  } 